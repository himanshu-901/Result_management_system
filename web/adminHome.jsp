...
<center><img src="kiitlogo.jpg" width="100" height="100">
<img src="mdu.jpg" align="right"  width="100" height="100"></center>
<br>
...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" style="text-align: center;background-color: yellow">Add New Student</div>
                        <div class="card-body">
...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" style="text-align: center;background-color: yellow">Insert New Result</div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Discrete Mathematics</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Computer Organization & Architecture</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Object oriented programming</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Web Technologies</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Operating system Lab</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
          ...
          <th>Computer Organization & Architecture</th>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: If Any errors occur then contact Developer.
Designed & Developed by Himanshu Sharma</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ KIIT :: 2008-2022</h5></center> 
  <hr class="new1">
<br>
</body>
</html>